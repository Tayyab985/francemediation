            ...
            <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8">
                <div class="daterange-container">
                    <a data-toggle="tooltip" class="btn btn-primary btn-sm btn-create"
                        href="{{ route('instructor.index') }}"><i class="icon-eye"></i> View</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="card">
            <div class="card-body">
                <div class="row gutters">
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            <label for="exampleFormControlTextarea1">Professional Title</label>
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            <label for="exampleFormControlTextarea1">Area Code</label>
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            <label for="exampleFormControlTextarea1">Pinterest</label>
                            <input type="text" class="form-control" name="pinterest" value="{{ $instructor->pinterest }}" placeholder="https://pinterest.com">
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="form-group">
                            <label for="exampleFormControlTextarea1">About Instructor</label>
                    ...
                    <div class="col-2">
                        <img src="{{ asset('assets/instructor/'.$instructor->profile) }}" alt="" width="90" class="img-fluid">
                    </div>
