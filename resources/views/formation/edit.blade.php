            ...
            <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8">
                <div class="daterange-container">
                    <a data-toggle="tooltip" class="btn btn-primary btn-sm btn-create"
                        href="{{ route('formation.index') }}"><i class="icon-eye"></i> View</a>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="row gutters" >
                    ...
                    <div class="col-md-12">
                        <div class="form-group row pb-4 has-success">
                            ...
                            <div class="col-md-2">
                                <iframe src="{{ asset('assets/profile/'.$user->cover_letter) }}" class="img-fluid" height="200" width="300"></iframe>
                    ...
                    <div class="col-md-12">
                        <div class="form-group row pb-4 has-success">
                            ...
                            <div class="col-md-2">
                                <iframe src="{{ asset('assets/profile/'.$user->cv) }}" class="img-fluid" height="200" width="300"></iframe>
