...
@section('main-content')
    <div role="main" class="main">
        ...
        <section class="section section-with-shape-divider section-parallax bg-tertiary border-0 m-0" data-plugin-parallax data-plugin-options="{'speed': 1.5, 'parallaxHeight': '110%', 'fadeIn': true}" data-image-src="{{ asset('assets/frontend/') }}/img/MainImage.jpg">
            ...
            <div class="container position-relative z-index-1 pb-5 my-5">
                <div class="appear-animation" data-appear-animation="fadeIn" data-appear-animation-delay="1000">
                    <div class="custom-svg-stars clean-animation-1">
                        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 277 276">
                            <g>
                                <path fill="none" stroke="#183f72" stroke-width="9" stroke-miterlimit="10" d="M51.5,165.5c-0.63,0.07,0.16,5.68-1,13c-0.52,3.27-1.5,9.11-5,15c-4.06,6.82-9.54,10.42-12,12
                            ...
                            <g>
                                <path fill="none" stroke="#183f72" stroke-width="9" stroke-miterlimit="10" d="M188.8,77.92c-1.01,0.11,0.26,9.06-1.6,20.74c-0.83,5.22-2.39,14.53-7.98,23.93
                            ...
                            <g>
                                <path fill="none" stroke="#183f72" stroke-width="9" stroke-miterlimit="10" d="M90.5,10.5c-0.63,0.07,0.16,5.68-1,13c-0.52,3.27-1.5,9.11-5,15c-4.06,6.82-9.54,10.42-12,12
											c-12.69,8.13-27.06,7.5-27,8c0.03,0.27,4.14-0.53,9,0c8.58,0.93,14.62,5.47,18,8c8.89,6.67,12.94,14.76,14,17
											c5.46,11.56,4.6,23.03,5,23c0.34-0.03-1.45-7.91,1-17c0.41-1.53,2.71-9.63,10-17c6.11-6.18,12.65-8.73,16-10
											c8.91-3.37,16.02-3.09,16-4c-0.03-1.04-9.22,0.41-19-4c-2.2-0.99-10.87-5.04-16-14c-3.08-5.38-4.54-11.95-7-23
                ...
                <div class="row justify-content-center justify-content-lg-start pb-5 mb-5">
                    <div class="col-md-10 col-lg-6 text-center text-lg-end pe-lg-4 pb-5 mb-5">
                        <h1 class="text-color-light font-weight-medium line-height-4 text-10 mb-2 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="300"> <span class="font-weight-extra-bold custom-highlight-1 ws-nowrap p-1 customHighlightAnim customHighlightAnimDelay">France Médiation</span> Tous Jours</h1>
                        <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="500">
                            <p class="custom-font-secondary font-weight-light custom-font-size-1 text-color-light opacity-6 mb-4">Médiation conventionnelle et judiciaire. </p>
                        </div>
                        <a href="#whoweare" data-hash data-hash-offset="0" data-hash-offset-lg="150" class="btn btn-secondary btn-modern font-weight-bold text-3 px-5 py-3 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="700">Plus d'informations</a>
                ...
                <div class="col-lg-6 pe-lg-4 mb-5 mb-lg-0">
                    <div class="card border-0 custom-border-radius-1 box-shadow-1 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="900">
                        <div class="card-body p-5">
                            <h2 class="text-color-secondary font-weight-bold text-7 line-height-1 mb-1">Demander un rappel
                            </h2>
                            <p class="custom-font-secondary text-4 pb-1 mb-4">Saisissez vos coordonnées dans le formulaire et nous vous rappellerons.</p>
                            <form class="contact-form custom-form-style-1" action="#" method="POST">
                                ...
                                <div class="row">
                                    <div class="form-group col pb-1 mb-3">
                                        <input type="text" value="" data-msg-required="Veuillez entrer votre nom." maxlength="100" class="form-control" name="name" placeholder="Votre nom" required>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col pb-1 mb-3">
                                        <input type="text" value="" data-msg-required="Veuillez entrer votre numéro de téléphone." maxlength="100" class="form-control" name="phone" placeholder="Votre numéro de téléphone" required>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col pb-1 mb-3">
                                        <div class="custom-select-1">
                                            <select data-msg-required="Veuillez choisir votre raison." class="form-control" name="service" required>
                                                <option value="" selected>Sélectionner le service</option>
                                                <option value="Build Services">Recrutement</option>
                                                <option value="Post Construction">Formation</option>
                                                <option value="Office Cleaning">Donation</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col">
                                        <button type="submit" class="btn btn-primary btn-modern font-weight-bold text-3 px-5 py-3" data-loading-text="Loading...">RAPPELLE-MOI</button>
                                    </div>
                                </div>
                            </form>
                        </div>
                        ...
                        <li class="mb-0">
									<span class="d-flex align-items-center justify-content-end justify-content-lg-end flex-column flex-lg-row font-weight-medium text-4 text-lg-3 text-xl-4">
										...
										<strong class="text-3 ms-lg-3">
											<a href="mailto:mail@domain.com" class="text-color-tertiary text-color-hover-primary text-decoration-underline">info@francemediation.com</a>
										</strong>
									</span>
                        </li>
                    </ul>
            ...
            <div class="row">
                <div class="col-6 col-xl-3 mb-5 mb-xl-0 appear-animation" data-appear-animation="fadeInLeftShorter" data-appear-animation-delay="200">
                    <div class="d-flex align-items-center justify-content-center flex-column flex-xl-row text-center">
                        <svg fill="none" height="30" stroke="#2d2f31" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" width="30" xmlns="http://www.w3.org/2000/svg">
                            <path d="M22 11.07V12a10 10 0 1 1-5.93-9.14"/>
                            <polyline points="23 3 12 14 9 11"/>
                        </svg>
                        <h3 class="text-transform-none text-color-dark font-weight-bold mb-0 text-4 ps-1 ms-xl-2 mt-3 mt-xl-0">ÉQUIPE PROFESSIONNELLE</h3>
                    </div>
                </div>
                <div class="col-6 col-xl-3 divider-left-border mb-5 mb-xl-0 appear-animation" data-appear-animation="fadeInLeftShorter">
                    <div class="d-flex align-items-center justify-content-center flex-column flex-xl-row text-center">
                        ...
                        <h3 class="text-transform-none text-color-dark font-weight-bold mb-0 text-4 px-2 px-sm-0 ps-1 ms-xl-2 mt-3 mt-xl-0">ANNÉES D'EXPÉRIENCE</h3>
                    </div>
                </div>
                <div class="col-6 col-xl-3 divider-left-border appear-animation" data-appear-animation="fadeInRightShorter">
                    <div class="d-flex align-items-center justify-content-center flex-column flex-xl-row text-center">
                        ...
                        <h3 class="text-transform-none text-color-dark font-weight-bold mb-0 text-4 px-3 px-sm-0 ps-1 ms-xl-2 mt-3 mt-xl-0">DES PRIX ABORDABLES</h3>
                    </div>
                </div>
                <div class="col-6 col-xl-3 divider-left-border appear-animation" data-appear-animation="fadeInRightShorter" data-appear-animation-delay="200">
                    <div class="d-flex align-items-center justify-content-center flex-column flex-xl-row text-center">
                        ...
                        <h3 class="text-transform-none text-color-dark font-weight-bold mb-0 text-4 ps-1 ms-xl-2 mt-3 mt-xl-0">DES PROFESSIONNELS QUALIFIÉS</h3>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-lg-5 mb-5 mb-lg-0">
                        <div class="d-flex align-items-center mb-2">
                            ...
                            <div class="overflow-hidden ms-3">
                                <h2 class="text-color-primary font-weight-semibold line-height-3 text-4 mb-0 appear-animation" data-appear-animation="maskRight" data-appear-animation-delay="1000">QUI NOUS SOMMES</h2>
                            </div>
                        </div>
                        <h3 class="text-color-secondary font-weight-bold text-transform-none line-height-2 text-10 mb-4 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="1200">
                            SERVICES DE MÉDIATION <br>
                            <span class="text-1 d-block">À VOTRE PORTE</span>
                        </h3>
                        <p class="custom-font-secondary text-4 mb-4 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="1400">Obtenez des services de médiation fiables et abordables pour vos besoins avec une garantie de satisfaction à 100% !</p>
                        <p class="pb-1 mb-3 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="1600">Cras a elit sit amet leo accumsan volutpat. Suspendisse hendrerit vehicula leo, vel efficitur felis ultrices non. Integer aliquet ullamcorper dolor, quis sollicitudin.</p>
                        <a href="demo-cleaning-services-about.html" class="btn btn-primary btn-modern font-weight-bold text-3 px-5 py-3 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="1800">voir plus</a>
                    </div>
                    <div class="col-sm-10 col-lg-6 offset-sm-1 ps-sm-5 ps-lg-0">
                        <div class="position-relative">
                            <!-- <div data-plugin-float-element data-plugin-options="{'startPos': 'top', 'speed': 0.2, 'transition': true, 'transitionDuration': 1000, 'isInsideSVG': true}">
                                <img src="{{ asset('assets/frontend/') }}/img/home/Home-services2.jpg" class="img-fluid rounded-circle custom-box-shadow-1 appear-animation" data-appear-animation="fadeInLeftShorter" data-appear-animation-delay="1800" alt="" />
                            </div> -->
                            <div class="position-absolute top-50pct left-50pct transform3dxy-n50" style="left: 25%;">
                                <div data-plugin-float-element data-plugin-options="{'startPos': 'top', 'speed': 0.3, 'transition': true, 'transitionDuration': 1000, 'isInsideSVG': true}">
                                    <img src="{{ asset('assets/frontend/') }}/img/home/Home-services3.jpg" class="img-fluid rounded-circle custom-box-shadow-1 appear-animation" data-appear-animation="fadeInLeftShorter" data-appear-animation-delay="1400" alt="" />
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row align-items-end pb-3 mb-5 mb-lg-4">
                    <div class="col-lg-7 col-xl-8 mb-4 mb-lg-0">
                        <div class="d-flex align-items-center mb-2">
                            <span class="custom-line appear-animation" data-appear-animation="customLineAnimation" appear-animation-duration="1s"></span>
                            <div class="overflow-hidden ms-3">
                                <h2 class="text-color-primary font-weight-semibold line-height-3 text-4 mb-0 appear-animation" data-appear-animation="maskRight" data-appear-animation-delay="1000">CE QUE NOUS FAISONS</h2>
                            </div>
                        </div>
                        <h3 class="text-color-secondary font-weight-bold text-transform-none text-8 mb-3 pb-1 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="1200">Nos Services</h3>
                    ...
                    <div class="col-lg-5 col-xl-4">
                        <div class="d-flex justify-content-lg-end">
                            <a href="javascript:void(0)" class="btn btn-primary btn-modern font-weight-bold text-3 btn-px-4 py-3 appear-animation" data-appear-animation="fadeInLeftShorter" data-appear-animation-delay="1800">VOIR TOUS LES SERVICES</a>
                            <a href="javascript:void(0)" class="btn btn-secondary btn-modern font-weight-bold text-3 btn-px-4 py-3 ms-4 appear-animation" data-appear-animation="fadeInLeftShorter" data-appear-animation-delay="1600">RÉSERVEZ MAINTENANT</a>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="card custom-card-style-1">
                                        <div class="card-body text-center py-5">
                                            <div class="custom-card-style-1-image-wrapper bg-primary rounded-circle d-inline-block mb-3">
                                                <img src="{{ asset('assets/frontend/') }}/img/home/Home-offer1.jpg" class="img-fluid rounded-circle" alt="" />
                                            </div>
                                            <h4 class="custom-card-style-1-title text-color-secondary font-weight-bold mb-2">Recrutement</h4>
                                            ...
                                            <span class="custom-card-style-1-link font-weight-bold">VOIR PLUS</span>
                                        </div>
                                    </div>
                                </a>
                            </div>
                            <div>
                                <a href="javascript:void(0)" class="text-decoration-none">
                                    <div class="card custom-card-style-1">
                                        <div class="card-body text-center py-5">
                                            <div class="custom-card-style-1-image-wrapper bg-primary rounded-circle d-inline-block mb-3">
                                                <img src="{{ asset('assets/frontend/') }}/img/home/Home-offer2.jpg" class="img-fluid rounded-circle" alt="" />
                                            </div>
                                            <h4 class="custom-card-style-1-title text-color-secondary font-weight-bold mb-2">Formation</h4>
                                            <p class="custom-card-style-1-description">Cras a elit sit amet leo accumsan volutpat. Suspendisse hendrerit vehicula leo, vel efficitur felis ultrices non. </p>
                                            <span class="custom-card-style-1-link font-weight-bold">VOIR PLUS</span>
                                        </div>
                                    </div>
                            ...
                            <div>
                                <a href="javascript:void(0)" class="text-decoration-none">
                                    <div class="card custom-card-style-1">
                                        <div class="card-body text-center py-5">
                                            <div class="custom-card-style-1-image-wrapper bg-primary rounded-circle d-inline-block mb-3">
                                                <img src="{{ asset('assets/frontend/') }}/img/home/Home-offers3.jpg" class="img-fluid rounded-circle" alt="" />
                                            </div>
                                            <h4 class="custom-card-style-1-title text-color-secondary font-weight-bold mb-2">Médiateurs</h4>
                                            <p class="custom-card-style-1-description">Cras a elit sit amet leo accumsan volutpat. Suspendisse hendrerit vehicula leo, vel efficitur felis ultrices non. </p>
                                            <span class="custom-card-style-1-link font-weight-bold">VOIR PLUS</span>
                                        </div>
                                    </div>
                            ...
                            <div>
                                <a href="javascript:void(0)" class="text-decoration-none">
                                    <div class="card custom-card-style-1">
                                        <div class="card-body text-center py-5">
                                            <div class="custom-card-style-1-image-wrapper bg-primary rounded-circle d-inline-block mb-3">
                                                <img src="{{ asset('assets/frontend/') }}/img/home/Home-offer4.jpg" class="img-fluid rounded-circle" alt="" />
                                            </div>
                                            <h4 class="custom-card-style-1-title text-color-secondary font-weight-bold mb-2">Nouvelles</h4>
                                            <p class="custom-card-style-1-description">Cras a elit sit amet leo accumsan volutpat. Suspendisse hendrerit vehicula leo, vel efficitur felis ultrices non. </p>
                                            <span class="custom-card-style-1-link font-weight-bold">VOIR PLUS</span>
                                        </div>
                                    </div>
        ...
        <section class="section section-with-shape-divider section-height-3 overlay overlay-show overlay-color-tertiary border-0 m-0" style="background-image: url({{ asset('assets/frontend/') }}/img/home/Home-bgScreen.jpg); background-size: cover; background-position: center;">
            ...
            <div class="container py-5 my-5">
                <div class="row align-items-center justify-content-center pt-3">
                    <div class="col-md-9 col-lg-7 col-xl-9 text-center text-xl-start mb-4 mb-xl-0">
                        <h2 class="text-color-light font-weight-medium line-height-4 text-9 negative-ls-1 mb-2">Pour <span class="font-weight-extra-bold custom-highlight-1 p-1 appear-animation" data-appear-animation="customHighlightAnim" data-appear-animation-delay="300">les solutions de </span> Médiation</h2>
                        <p class="custom-font-secondary custom-font-size-1 font-weight-light text-color-light opacity-8 mb-0">Notre personnel est formé pour répondre à tous vos besoins!</p>
                    </div>
                    <div class="col-xl-3 text-center text-xl-end">
                        <div class="position-relative">
                            <a href="javascript:void(0)" class="btn btn-secondary btn-modern font-weight-bold text-3 btn-px-4 py-3 appear-animation" data-appear-animation="fadeInRightShorter" data-appear-animation-delay="550">RÉSERVEZ MAINTENANT EN 60 SECONDES</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-8">
                        <div class="d-flex align-items-center mb-2">
                            <span class="custom-line appear-animation" data-appear-animation="customLineAnimation" appear-animation-duration="1s"></span>
                            <div class="overflow-hidden ms-3">
                                <h2 class="text-color-primary font-weight-semibold line-height-3 text-4 mb-0 appear-animation" data-appear-animation="maskRight" data-appear-animation-delay="1000">POURQUOI NOUS CHOISIR</h2>
                            </div>
                        </div>
                        <h3 class="text-color-secondary font-weight-bold text-transform-none text-8 mb-3 pb-1 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="1200">Nos Avantages</h3>
                ...
                <div class="row align-items-center justify-content-center mb-4">
                                ...
                                <div class="card-header" id="collapse1HeadingOne">
                                    <h4 class="card-title m-0">
                                        <a class="accordion-toggle text-color-dark font-weight-bold collapsed" data-bs-toggle="collapse" data-bs-target="#collapse1One" aria-expanded="false" aria-controls="collapse1One">
                                            1 - Pourquoi choisir France Médiation Tous Jours ?
                                        </a>
                                    </h4>
                                </div>
                    ...
                    <div class="col-sm-9 col-lg-5 ps-sm-5">
                        <div class="position-relative">
                            <div data-plugin-float-element data-plugin-options="{'startPos': 'top', 'speed': 0.2, 'transition': true, 'transitionDuration': 1000, 'isInsideSVG': true}">
                                <img src="{{ asset('assets/frontend/') }}/img/home/Home-whyus2.jpg" class="img-fluid rounded-circle custom-box-shadow-1 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="1200" alt="" />
                            </div>
                            <div class="position-absolute top-50pct left-50pct transform3dxy-n50" style="left: 25%;">
                                <div data-plugin-float-element data-plugin-options="{'startPos': 'top', 'speed': 0.3, 'transition': true, 'transitionDuration': 1000, 'isInsideSVG': true}">
                                    <img src="{{ asset('assets/frontend/') }}/img/home/Home-whyus1.jpg" class="img-fluid rounded-circle custom-box-shadow-1 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="1400" alt="" />
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container py-5 my-5">
                <div class="row justify-content-center pb-2 mt-2 mb-4">
                    <div class="col-lg-9 text-center">
                        <h2 class="text-color-secondary font-weight-bold text-8 mb-3 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200">Notre processus</h2>
                        <p class="custom-font-secondary text-4 mb-4 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="400">Obtenez des services de médiation fiables et abordables pour vos besoins avec une garantie de satisfaction à 100% !</p>
                        <p class="mb-0 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="600">Cras a elit sit amet leo accumsan volutpat. Suspendisse hendrerit vehicula leo, vel efficitur felis ultrices non. Integer aliquet ullamcorper dolor, quis sollicitudin.</p>
                    </div>
                </div>
                    ...
                    <div class="row justify-content-center">
                            ...
                            <div class="featured-box featured-box-primary featured-box-effect-5 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="300">
                                <div class="box-content text-center">
                                    <div class="custom-featured-icon-wrapper bg-secondary mb-4">
                                        <img src="{{ asset('assets/frontend/') }}/img/demos/cleaning-services/icons/icon-1.png" class="img-fluid icon-featured" alt="" />
                                    </div>
                                    <h3 class="text-transform-none font-weight-bold custom-font-size-1 mb-3">Livre en ligne</h3>
                        ...
                        <div class="col-md-8 col-lg-4">
                            <div class="featured-box featured-box-primary featured-box-effect-5 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="500">
                                <div class="box-content text-center">
                                    <div class="custom-featured-icon-wrapper bg-secondary mb-4">
                                        <img src="{{ asset('assets/frontend/') }}/img/demos/cleaning-services/icons/icon-2.png" class="img-fluid icon-featured" alt="" />
                                    </div>
                                    <h3 class="text-transform-none font-weight-bold custom-font-size-1 mb-3">Processus Propre</h3>
                                    <p class="px-3 mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc viverra erat orci, ac auctor.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-8 col-lg-4">
                            <div class="featured-box featured-box-primary featured-box-effect-5 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="700">
                                <div class="box-content text-center">
                                    <div class="custom-featured-icon-wrapper bg-secondary mb-4">
                                        <img src="{{ asset('assets/frontend/') }}/img/demos/cleaning-services/icons/icon-3.png" class="img-fluid icon-featured" alt="" />
                                    </div>
                                    <h3 class="text-transform-none font-weight-bold custom-font-size-1 mb-3">Tu te détends</h3>
                                    <p class="px-3 mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc viverra erat orci, ac auctor.</p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row align-items-end pb-3 mb-5 mb-lg-4">
                    <div class="col-lg-7 col-xl-8 mb-4 mb-lg-0">
                        <div class="d-flex align-items-center mb-2">
                            <span class="custom-line appear-animation" data-appear-animation="customLineAnimation" appear-animation-duration="1s"></span>
                            <div class="overflow-hidden ms-3">
                                <h2 class="text-color-primary font-weight-semibold line-height-3 text-4 mb-0 appear-animation" data-appear-animation="maskRight" data-appear-animation-delay="1000">PROFIL DE TRAVAIL</h2>
                            </div>
                        </div>
                        <h3 class="text-color-secondary font-weight-bold text-transform-none text-8 mb-3 pb-1 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="1200">Notre Portefeuille</h3>
                        <p class="mb-0 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="1400">Cras a elit sit amet leo accumsan volutpat. Suspendisse hendrerit vehicula leo, vel efficitur felis ultrices non. Integer aliquet ullamcorper dolor, quis sollicitudin. Integer aliquet ullamcorper dolor, quis sollicitudin.</p>
                    </div>
                    <div class="col-lg-5 col-xl-4">
                        <div class="d-flex justify-content-lg-end">
                            <a href="javascript:void(0)" class="btn btn-primary btn-modern font-weight-bold text-3 btn-px-4 py-3 appear-animation" data-appear-animation="fadeInLeftShorter" data-appear-animation-delay="1800">NOTRE TRAVAIL</a>
                            <a href="javascript:void(0)" class="btn btn-secondary btn-modern font-weight-bold text-3 btn-px-4 py-3 ms-4 appear-animation" data-appear-animation="fadeInLeftShorter" data-appear-animation-delay="1600">RÉSERVEZ MAINTENANT</a>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="owl-carousel nav-outside nav-arrows-1 custom-carousel-box-shadow-1 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="750" data-plugin-options="{'responsive': {'0': {'items': 1}, '479': {'items': 1}, '768': {'items': 2}, '979': {'items': 2}, '1199': {'items': 2}}, 'autoplay': false, 'autoplayTimeout': 5000, 'autoplayHoverPause': true, 'dots': false, 'nav': true, 'loop': false, 'margin': 20, 'stagePadding': '75'}">
                                ...
                                <a href="javascript:void(0)" class="text-decoration-none">
                                    <div class="thumb-info thumb-info-no-borders thumb-info-no-borders-rounded thumb-info-centered-icons thumb-info-hide-wrapper-bg">
                                        <div class="thumb-info-wrapper overlay overlay-color-secondary">
                                            <img src="{{ asset('assets/frontend/') }}/img/home/Home-portfolio1.jpg" class="img-fluid" alt="">
                                            <div class="thumb-info-action text-center flex-column">
                                                <h4 class="text-color-light font-weight-bold text-6 mb-1">Formation</h4>
                                                <span class="d-block text-color-light font-weight-light">Médiateurs</span>
                                            </div>
                                        </div>
                                    </div>
                                </a>
                            ...
                            <div>
                                <a href="javascript:void(0)" class="text-decoration-none">
                                    <div class="thumb-info thumb-info-no-borders thumb-info-no-borders-rounded thumb-info-centered-icons thumb-info-hide-wrapper-bg">
                                        <div class="thumb-info-wrapper overlay overlay-color-secondary">
                                            <img src="{{ asset('assets/frontend/') }}/img/home/Home-portfolio2.jpg" class="img-fluid" alt="">
                                            <div class="thumb-info-action text-center flex-column">
                                                <h4 class="text-color-light font-weight-bold text-6 mb-1">Devenir Un Médiateur</h4>
                                                <span class="d-block text-color-light font-weight-light">Rejoignez Notre équipe</span>
                                            </div>
                                        </div>
                                    </div>
                                </a>
                            ...
                            <div>
                                <a href="javascript:void(0)" class="text-decoration-none">
                                    <div class="thumb-info thumb-info-no-borders thumb-info-no-borders-rounded thumb-info-centered-icons thumb-info-hide-wrapper-bg">
                                        <div class="thumb-info-wrapper overlay overlay-color-secondary">
                                            <img src="{{ asset('assets/frontend/') }}/img/home/Home-portfolio4.jpg" class="img-fluid" alt="">
                                            <div class="thumb-info-action text-center flex-column">
                                                <h4 class="text-color-light font-weight-bold text-6 mb-1">Nouvelles des associations</h4>
                                                <span class="d-block text-color-light font-weight-light">France Médiation </span>
                                            </div>
                                        </div>
                                    </div>
                                </a>
                            ...
                            <div>
                                <a href="javascript:void(0)" class="text-decoration-none">
                                    <div class="thumb-info thumb-info-no-borders thumb-info-no-borders-rounded thumb-info-centered-icons thumb-info-hide-wrapper-bg">
                                        <div class="thumb-info-wrapper overlay overlay-color-secondary">
                                            <img src="{{ asset('assets/frontend/') }}/img/demos/cleaning-services/portfolio/portfolio-4.jpg" class="img-fluid" alt="">
                                            <div class="thumb-info-action text-center flex-column">
                            ...
                            <div>
                                <div class="card custom-card-style-1 custom-card-style-1-variation">
                                    <div class="card-body text-center bg-color-light-scale-1 py-5">
                                        <div class="custom-card-style-1-image-wrapper bg-primary rounded-circle d-inline-block mb-3">
                                            <a href="#">
                                                <img src="{{ asset('assets/frontend/') }}/img/home/laywer1.jpg" class="img-fluid rounded-circle" alt="" />
                                            </a>
                                        </div>
                                        ...
                                        <p class="text-2 pb-1 mb-2">Director</p>
                            ...
                            <div>
                                <div class="card custom-card-style-1 custom-card-style-1-variation">
                                    <div class="card-body text-center bg-color-light-scale-1 py-5">
                                        <div class="custom-card-style-1-image-wrapper bg-primary rounded-circle d-inline-block mb-3">
                                            <a href="#">
                                                <img src="{{ asset('assets/frontend/') }}/img/home/lawyer2.jpg" class="img-fluid rounded-circle" alt="" />
                                            </a>
                                        </div>
                                        <h4 class="text-color-secondary font-weight-bold line-height-1 text-5 mb-0"><a href="#" class="text-color-secondary text-color-hover-primary text-decoration-none">Jack Doe</a></h4>
                                        <p class="text-2 pb-1 mb-2">Regional Director</p>
                                        <ul class="social-icons custom-social-icons social-icons-big">
                                            <li class="social-icons-instagram"><a href="http://www.instagram.com/" target="_blank" title="Instagram"><i class="fab fa-instagram"></i></a></li>
                                            <li class="social-icons-twitter mx-2"><a href="http://www.twitter.com/" target="_blank" title="Twitter"><i class="fab fa-twitter"></i></a></li>
                                            <li class="social-icons-facebook"><a href="http://www.facebook.com/" target="_blank" title="Facebook"><i class="fab fa-facebook-f"></i></a></li>
                            ...
                            <div>
                                <div class="card custom-card-style-1 custom-card-style-1-variation">
                                    <div class="card-body text-center bg-color-light-scale-1 py-5">
                                        <div class="custom-card-style-1-image-wrapper bg-primary rounded-circle d-inline-block mb-3">
                                            <a href="#">
                                                <img src="{{ asset('assets/frontend/') }}/img/home/lawyer3.jpg" class="img-fluid rounded-circle" alt="" />
                                            </a>
                                        </div>
                                        <h4 class="text-color-secondary font-weight-bold line-height-1 text-5 mb-0"><a href="#" class="text-color-secondary text-color-hover-primary text-decoration-none">Adams Gilbert</a></h4>
                                        <p class="text-2 pb-1 mb-2">Regional Manager</p>
                                        <ul class="social-icons custom-social-icons social-icons-big">
                                            <li class="social-icons-instagram"><a href="http://www.instagram.com/" target="_blank" title="Instagram"><i class="fab fa-instagram"></i></a></li>
                                            <li class="social-icons-twitter mx-2"><a href="http://www.twitter.com/" target="_blank" title="Twitter"><i class="fab fa-twitter"></i></a></li>
                                            <li class="social-icons-facebook"><a href="http://www.facebook.com/" target="_blank" title="Facebook"><i class="fab fa-facebook-f"></i></a></li>
                            ...
                            <div>
                                <div class="card custom-card-style-1 custom-card-style-1-variation">
                                    <div class="card-body text-center bg-color-light-scale-1 py-5">
                                        <div class="custom-card-style-1-image-wrapper bg-primary rounded-circle d-inline-block mb-3">
                                            <a href="#">
                                                <img src="{{ asset('assets/frontend/') }}/img/demos/cleaning-services/team/team-1.jpg" class="img-fluid rounded-circle" alt="" />
                                            </a>
                                        </div>
                                        <h4 class="text-color-secondary font-weight-bold line-height-1 text-5 mb-0"><a href="#" class="text-color-secondary text-color-hover-primary text-decoration-none">John Doe</a></h4>
                                        <p class="text-2 pb-1 mb-2">General Manager</p>
                                        <ul class="social-icons custom-social-icons social-icons-big">
                                            <li class="social-icons-instagram"><a href="http://www.instagram.com/" target="_blank" title="Instagram"><i class="fab fa-instagram"></i></a></li>
                                            <li class="social-icons-twitter mx-2"><a href="http://www.twitter.com/" target="_blank" title="Twitter"><i class="fab fa-twitter"></i></a></li>
                                            <li class="social-icons-facebook"><a href="http://www.facebook.com/" target="_blank" title="Facebook"><i class="fab fa-facebook-f"></i></a></li>
            ...
            <div class="container pt-5 pb-3 mt-4">
                <div class="row mt-5 mb-5">
                    <div class="col-lg-4 pe-lg-0 mb-4 mb-lg-0">
                        <h2 class="text-color-light font-weight-bold line-height-6 text-8 mb-3">Nos clients heureux</h2>
                        ...
                        <div class="owl-carousel dots-light dots-align-left" data-plugin-options="{'responsive': {'0': {'items': 1}, '479': {'items': 1}, '979': {'items': 2}, '1199': {'items': 2}}, 'margin': 20, 'loop': true, 'dots': true, 'dotsEach': 1, 'nav': false, 'autoplay': true, 'autoplayTimeout': 5000}">
                                ...
                                <div class="testimonial testimonial-style-3 custom-testimonial-style-1">
                                    ...
                                    <div class="testimonial-author">
                                        <div class="testimonial-author-thumbnail">
                                            <img src="{{ asset('assets/frontend/') }}/img/clients/client-1.jpg" class="img-fluid rounded-circle" alt="">
                                        </div>
                                        <p><strong class="text-color-light font-weight-semibold text-4 mb-1">John Smith</strong><span class="text-color-light text-2">NEW YORK</span></p>
                                    </div>
                                </div>
                            </div>
                            <div>
                                <div class="testimonial testimonial-style-3 custom-testimonial-style-1">
                                    ...
                                    <div class="testimonial-author">
                                        <div class="testimonial-author-thumbnail">
                                            <img src="{{ asset('assets/frontend/') }}/img/clients/client-2.jpg" class="img-fluid rounded-circle" alt="">
                                        </div>
                                        <p><strong class="text-color-light font-weight-semibold text-4 mb-1">Monica Doe</strong><span class="text-color-light text-2">NEW YORK</span></p>
                                    </div>
                                </div>
                            </div>
                            <div>
                                <div class="testimonial testimonial-style-3 custom-testimonial-style-1">
                                    ...
                                    <div class="testimonial-author">
                                        <div class="testimonial-author-thumbnail">
                                            <img src="{{ asset('assets/frontend/') }}/img/clients/client-3.jpg" class="img-fluid rounded-circle" alt="">
                                        </div>
                                        <p><strong class="text-color-light font-weight-semibold text-4 mb-1">John Smith</strong><span class="text-color-light text-2">NEW YORK</span></p>
                                    </div>
                                </div>
                            ...
                            <div>
                                <div class="testimonial testimonial-style-3 custom-testimonial-style-1">
                                    ...
                                    <div class="testimonial-author">
                                        <div class="testimonial-author-thumbnail">
                                            <img src="{{ asset('assets/frontend/') }}/img/clients/client-4.jpg" class="img-fluid rounded-circle" alt="">
                                        </div>
                                        <p><strong class="text-color-light font-weight-semibold text-4 mb-1">John Doe</strong><span class="text-color-light text-2">NEW YORK</span></p>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <section class="section border-0 pt-4 m-0">
            <div class="container">
                <div class="row justify-content-center pb-2 mb-3">
                    <div class="col-md-9 col-lg-12 text-center">
                        <h2 class="text-color-secondary font-weight-bold line-height-6 mb-3 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200">Nos Prix</h2>
                        <p class="custom-font-secondary text-4 mb-3 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="400">Cras a elit sit amet leo accumsan volutpat. Suspendisse hendrerit vehicula leo, vel efficitur felis ultri.</p>
                    </div>
                </div>
                <div class="row appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="600">
                    <div class="col">
                        <div class="owl-carousel nav-outside nav-arrows-1 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="750" data-plugin-options="{'responsive': {'0': {'items': 1}, '479': {'items': 1}, '768': {'items': 2}, '979': {'items': 3}, '1199': {'items': 4}}, 'autoplay': false, 'autoplayTimeout': 5000, 'autoplayHoverPause': true, 'dots': false, 'nav': true, 'loop': false, 'margin': 20, 'stagePadding': '75'}">
                            <div>
                                <div class="card custom-card-style-1">
                                    <div class="card-body text-center py-5 px-4">
                                        <h3 class="text-color-primary font-weight-medium text-4 pb-1 mb-4">LEO ACCUMSAN</h3>
                                        ...
                                        <ul class="list list-unstyled pb-1 mb-4">
                                            <li class="d-flex align-items-center justify-content-center">
                                                ...
                                                <span class="ms-1">Suspendisse hendrerit</span>
                                            </li>
                                            <li class="d-flex align-items-center justify-content-center">
                                                <svg fill="none" height="17" stroke="#848484" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M22 11.07V12a10 10 0 1 1-5.93-9.14"/>
                                        ...
                                        <a href="#" class="btn btn-secondary btn-modern font-weight-bold text-3 px-5 btn-py-3">RÉSERVEZ MAINTENANT</a>
                                    </div>
                                </div>
                            </div>
                            <div>
                                <div class="card custom-card-style-1">
                                    <div class="card-body text-center py-5 px-4">
                                        <h3 class="text-color-primary font-weight-medium text-4 pb-1 mb-4">QUIS SOLLICITUDIN</h3>
                                        <div class="price d-flex align-items-end justify-content-center font-weight-bold text-color-dark text-12 line-height-1 pb-1 mb-4">
                                            <span class="price-unit font-weight-normal custom-font-size-4 position-relative bottom-6">$</span>
                                            79
                                        </div>
                                        <ul class="list list-unstyled pb-1 mb-4">
                                            <li class="d-flex align-items-center justify-content-center">
                                                ...
                                                <span class="ms-1">Ullamcorper Dolor</span>
                                            </li>
                                            <li class="d-flex align-items-center justify-content-center">
                                                <svg fill="none" height="17" stroke="#848484" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M22 11.07V12a10 10 0 1 1-5.93-9.14"/>
                                            ...
                                            <li class="d-flex align-items-center justify-content-center">
                                                ...
                                                <span class="ms-1">Vehicula Leo</span>
                                            </li>
                                            <li class="d-flex align-items-center justify-content-center">
                                                <svg fill="none" height="17" stroke="#848484" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M22 11.07V12a10 10 0 1 1-5.93-9.14"/>
                                                ...
                                                <span class="ms-1">Aliquet Ullamcorper</span>
                                            </li>
                                            <li class="d-flex align-items-center justify-content-center">
                                                <svg fill="none" height="17" stroke="#848484" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M22 11.07V12a10 10 0 1 1-5.93-9.14"/>
                                                ...
                                                <span class="ms-1">Sit Amet Leo</span>
                                            </li>
                                        </ul>
                                        <a href="#" class="btn btn-secondary btn-modern font-weight-bold text-3 px-5 btn-py-3">RÉSERVEZ MAINTENANT</a>
                                    </div>
                            ...
                            <div>
                                <div class="card custom-card-style-1">
                                    <div class="card-body text-center py-5 px-4">
                                        <h3 class="text-color-primary font-weight-medium text-4 pb-1 mb-4">SIT AMET LEO</h3>
                                        <div class="price d-flex align-items-end justify-content-center font-weight-bold text-color-dark text-12 line-height-1 pb-1 mb-4">
                                            <span class="price-unit font-weight-normal custom-font-size-4 position-relative bottom-6">$</span>
                                            89
                                        </div>
                            ...
                            <div>
                                <div class="card custom-card-style-1">
                                    <div class="card-body text-center py-5 px-4">
                                        ...
                                        <a href="javascript:void(0)" class="btn btn-secondary btn-modern font-weight-bold text-3 px-5 btn-py-3">RÉSERVEZ MAINTENANT</a>
                                    </div>
                                </div>
                            </div>
                            <div>
        ...
        <section class="section section-with-shape-divider overlay overlay-show border-0 m-0" style="background-image: url({{ asset('assets/frontend/') }}/img/home/Home-bg2.jpg); background-size: cover; background-position: center;">
            <div class="shape-divider shape-divider-reverse-x" style="height: 102px;">
                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 1920 102" preserveAspectRatio="xMinYMin">
                    <path fill="#F7F7F7" d="M1895,78c-56.71-6.03-113.75-12.1-167-17c-75.42-6.94-133.81-10.66-171-13c-62.1-3.91-108.85-5.97-155-8
								c-35.96-1.58-78.06-3.42-133-5c-59.81-1.72-103.18-2.23-172-3c-92.17-1.03-154.41-1.01-169-1c-69.05,0.05-115.16,0.67-137,1
            ...
            <div class="container py-5 mt-5 mb-3">
                <div class="row justify-content-center py-5 my-4">
                    <div class="col-lg-9 col-xl-7 text-center px-lg-4">
                        <h2 class="text-color-light font-weight-medium text-11 line-height-5 mb-2 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200">Services de Médiation  <span class="font-weight-bold custom-highlight-1 ws-nowrap custom-highlight-1-primary p-2 appear-animation" data-appear-animation="customHighlightAnim" data-appear-animation-delay="1s">De Haute Qualité</span> pour tous les types d'établissements</h2>
                        <p class="custom-font-secondary custom-font-size-1 custom-text-color-1 pb-2 mb-4 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="400">Notre personnel est formé pour vous aider dans tous vos besoins.</p>
                        <a href="javascript:void(0)" class="btn btn-secondary btn-modern font-weight-bold text-3 px-5 btn-py-3 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="600">VOIR LES PRIX</a>
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="row align-items-end pb-3 mb-4">
                    <div class="col-lg-9 col-xl-10 mb-4 mb-lg-0">
                        <div class="d-flex align-items-center pb-1 mb-2">
                            <span class="custom-line appear-animation" data-appear-animation="customLineAnimation" appear-animation-duration="1s"></span>
                            <div class="overflow-hidden ms-3">
                                <h2 class="text-color-primary font-weight-semibold line-height-3 text-4 mb-0 appear-animation" data-appear-animation="maskRight" data-appear-animation-delay="1000">NOTRE BLOG</h2>
                            </div>
                        </div>
                        <h3 class="text-color-secondary font-weight-bold text-transform-none text-8 mb-3 pb-1 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="1200">Nouvelles et Articles</h3>
                        <p class="mb-0 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="1400">Cras a elit sit amet leo accumsan volutpat. Suspendisse hendrerit vehicula leo, vel efficitur felis ultrices non. Integer aliquet ullamcorper dolor, quis sollicitudin. Integer aliquet ullamcorper dolor, quis sollicitudin.</p>
                    </div>
                    <div class="col-lg-auto px-lg-0">
                        <div class="d-flex justify-content-lg-end">
                            <a href="#" class="btn btn-secondary btn-modern font-weight-bold text-3 px-5 py-3 appear-animation" data-appear-animation="fadeInLeftShorter" data-appear-animation-delay="1600">VIEW BLOG</a>
                        </div>
                    </div>
                </div>
                <div class="row">
                        ...
                        <article class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="1800">
                            <div class="card border-0 border-radius-0 box-shadow-1">
                                <div class="card-body p-3 z-index-1">
                                    <a href="#">
                                        <img class="card-img-top border-radius-0 mb-2" src="{{ asset('assets/frontend/') }}/img/demos/cleaning-services/blog/blog-1.jpg" alt="Card Image">
                                    </a>
                                    ...
                                    <div class="card-body p-0">
                                        ...
                                        <a href="javascript:void(0)" class="btn btn-link font-weight-semibold text-decoration-none text-3 ps-0">READ MORE</a>
                                    </div>
                                </div>
                            </div>
                        </article>
                    ...
                    <div class="col-lg-4 mb-5 mb-lg-0">
                        <article class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="2000">
                            <div class="card border-0 border-radius-0 box-shadow-1">
                                <div class="card-body p-3 z-index-1">
                                    <a href="#">
                                        <img class="card-img-top border-radius-0 mb-2" src="{{ asset('assets/frontend/') }}/img/demos/cleaning-services/blog/blog-2.jpg" alt="Card Image">
                                    </a>
                                    <p class="text-uppercase text-color-default text-1 my-2">
                                        <time pubdate datetime="2022-01-10">10 Jan 2022</time>
                                        <span class="opacity-3 d-inline-block px-2">|</span>
                    ...
                    <div class="col-lg-4">
                        <div class="row">
                            <div class="col-12">
                                <h3 class="text-color-secondary font-weight-bold text-transform-none text-6 mb-3 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="2200">More Articles</h3>
